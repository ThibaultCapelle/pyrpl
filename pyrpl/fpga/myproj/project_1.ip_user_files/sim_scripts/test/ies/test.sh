...
create_lib_mappings()
{
  libs=(generic_baseblocks_v2_1_0 fifo_generator_v13_0_1 axi_data_fifo_v2_1_6 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_7 axi_protocol_converter_v2_1_7 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_8)
  file="cds.lib"
  dir="ies"
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/test/ip/test_axi_protocol_converter_0_0/sim/test_axi_protocol_converter_0_0.v" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/test/ip/test_proc_sys_reset_0/sim/test_proc_sys_reset_0.vhd" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/test/ip/test_processing_system7_0/sim/test_processing_system7_0.v" \
    "$ref_dir/../../../bd/test/ipshared/xilinx.com/xlconstant_v1_1/xlconstant.v" \
    "$ref_dir/../../../bd/test/ip/test_xlconstant_0/sim/test_xlconstant_0.v" \
    "$ref_dir/../../../bd/test/hdl/test.v" \
...
elaborate()
{
  ...
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname generic_baseblocks_v2_1_0 -libname fifo_generator_v13_0_1 -libname axi_data_fifo_v2_1_6 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_7 -libname axi_protocol_converter_v2_1_7 -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_8"
  ncelab $opts xil_defaultlib.test xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.test -input simulate.do
}
# Script usage
usage()
{

...
(* CORE_GENERATION_INFO = "test,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=test,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,synth_mode=Global}" *) (* HW_HANDOFF = "test.hwdef" *) 
module test
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  test_axi_protocol_converter_0_0 axi_protocol_converter_0
  ...
  test_proc_sys_reset_0 proc_sys_reset
  ...
  test_processing_system7_0 processing_system7
